...
3. region: the census region where the respondent lives; numeric numbers starting from 1 correspond to options "Northeast", "Midwest", "South", and "West", respectively.

4. race: the racial or ethnic group of the respondent; numeric numbers starting from 1 correspond to options "White", "Black", "Hispanic", "Asian", "Native American", "Middle Eastern", "Two or more races", and "Other", respectively.
...
More detailed explanation of each plot can be found in -@sec-model-details.
...
Our discussion is made based on @tbl-modelresults1 from our model, as well as background information on different presidential candidates and their different views of the world and divergent approaches to tackling some of the  issues in the United States.
