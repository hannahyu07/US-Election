...
Our discussion is made primarily based on the logistic regression model and its result in @tbl-modelresults1, as well as background information on the two presidential candidates, Trump and Biden, and their different views of the world and divergent approaches to tackling some of the issues in the United States.
