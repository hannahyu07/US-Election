...
3. region: the census region where the respondent lives; options are "Northeast", "Midwest", "South", and "West".

4. race: the racial or ethnic group of the respondent; options are "White", "Black", "Hispanic", "Asian", "Native American", "Middle Eastern", "Two or more races", and "Other".

5. employ: the current employment status of the respondent; options are "Full-time", "Part-time", "Temporarily laid off", "Unemployed", "Retired", "Permanently disabled", "Homemaker", "Student", and "Other".
